...
function Scatter(id, data, xField, yField, sField, label, type, part, master){
    ...
    self.init = function(){
        ...
        self.scatter = self.element.append("div").attr("class", "scScatter");
            ...
            //Y Axis
            self.yField = yField;
            s.yValue = function (d) { return d[self.yField]; }
...
function calc(data)
{
    ...
    console.log(data);
     data.forEach(function(feature){
        ...
        feature.isVH1 = feature.isV1 * feature.isH1;
        feature.isVH2 = feature.isV2 * feature.isH2;
        feature.isVH3 = feature.isV3 * feature.isH3;
        feature.isVH4 = feature.isV4 * feature.isH4;
        feature.isVH5 = feature.isV5 * feature.isH5;
        
        feature.totalVH = feature.isVH1 + feature.isVH2 + feature.isVH3 + feature.isVH4 + feature.isVH5;
        feature.isVH1 = feature.isVH1 / feature.totalVH; 
        feature.isVH2 = feature.isVH2 / feature.totalVH;
        feature.isVH3 = feature.isVH3 / feature.totalVH;
        feature.isVH4 = feature.isVH4 / feature.totalVH;
        feature.isVH5 = feature.isVH5 / feature.totalVH;
        feature.totalVH = feature.isVH1 + feature.isVH2 + feature.isVH3 + feature.isVH4 + feature.isVH5;
        feature.varianceVH = variance([ feature.isVH1,  feature.isVH2,  feature.isVH3,  feature.isVH4,  feature.isVH5])
         
        //Ratio
        feature.isR1 = Math.abs(totals.is1P - feature.isH1);
        feature.isR2 = Math.abs(totals.is2P - feature.isH2);
        feature.isR3 = Math.abs(totals.is3P - feature.isH3);
        feature.isR4 = Math.abs(totals.is4P - feature.isH4);
        feature.isR5 = Math.abs(totals.is5P - feature.isH5);
        feature.totalR = feature.isR1 + feature.isR2 + feature.isR3 + feature.isR4 + feature.isR5;
        feature.varianceR = variance([ feature.isR1,  feature.isR2,  feature.isR3,  feature.isR4,  feature.isR5]) 
        
        
        //Distance
        feature.isD1 = feature.isH1;
        feature.isD2 = feature.isH2;
        feature.isD3 = feature.isH3;
        feature.isD4 = feature.isH4;
        feature.isD5 = feature.isH5;
        feature.totalD = feature.isD1 + feature.isD2 + feature.isD3 + feature.isD4 + feature.isD5;
        feature.varianceD = Math.sqrt(
        ...
        feature.isD5 = feature.isH5;
        feature.totalD = feature.isD1 + feature.isD2 + feature.isD3 + feature.isD4 + feature.isD5;
         var part1 = (totals.is1P*feature.isD1 + 
            totals.is2P*feature.isD2 + 
            totals.is3P*feature.isD3 + 
            totals.is4P*feature.isD4 + 
            totals.is5P*feature.isD5)
         var part2 = (Math.pow(totals.is1P,2) + 
                 Math.pow(totals.is2P,2) + 
                 Math.pow(totals.is3P,2) + 
                 Math.pow(totals.is4P,2) + 
                 Math.pow(totals.is5P,2))
         var part3 = (Math.pow(feature.isD1,2) + 
        ...
        feature.varianceC = 1 -
            ...
            totals.is5P*feature.isD5)/
            (
                Math.sqrt((Math.pow(totals.is1P,2) + 
                 Math.pow(totals.is2P,2) + 
                 Math.pow(totals.is3P,2) + 
                 Math.pow(totals.is4P,2) + 
                 Math.pow(totals.is5P,2))) * 
                Math.sqrt((Math.pow(feature.isD1,2) + 
                 Math.pow(feature.isD2,2) + 
                 Math.pow(feature.isD3,2) + 
                 Math.pow(feature.isD4,2) + 
                 Math.pow(feature.isD5,2))) 
